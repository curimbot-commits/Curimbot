    ...
    <span class="flex items-center space-x-2" (click)="onSwitchChange()">
      ...
      >
        <span
          ...
          [attr.data-state]="status()"
          class="pointer-events-none block h-5 w-5 rounded-full transition-colors transition-transform shadow-lg ring-0
            data-[state=checked]:translate-x-2.5
            data-[state=unchecked]:translate-x-0
            data-[state=checked]:bg-[#02ab74]
            data-[state=unchecked]:bg-[#a3e4cf]
            data-[size=sm]:w-4 data-[size=sm]:h-4
            data-[size=sm]:data-[state=checked]:translate-x-4
            data-[size=sm]:data-[state=unchecked]:translate-x-0
            data-[size=lg]:w-6 data-[size=lg]:h-6
            data-[size=lg]:data-[state=checked]:translate-x-6
